...
# TrollPyla: the humour layer is a single, optional integration point.
# Deleting this import and the register_troll() call below yields vanilla PylaAI.
from troll import console as troll_console, register_troll
...
if __name__ == "__main__":
    ...
    register_troll(app)  # TrollPyla: mounts /api/troll, never touches the bot core
    local_url = f"http://127.0.0.1:{port}"
    troll_console.announce(local_url)
